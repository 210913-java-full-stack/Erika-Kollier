...
//   }
  ...
  function ticketPurchase() {
      ...
      let userTicketData = {tickets: {currentCity: userFrom, destCity: userTo, tickets:userTicket, departure:userDeparture, arrival:userArrival}}

      console.log(`ticketInfo => ${userTicketData.tickets.currentCity} ${userTicketData.tickets.destCity} ${userTicketData.tickets.tickets} ${userTicketData.tickets.departure} ${userTicketData.tickets.arrival}`
      )
      let url = "http://localhost:8080/Erika-Kollier/ticketPurchase"
